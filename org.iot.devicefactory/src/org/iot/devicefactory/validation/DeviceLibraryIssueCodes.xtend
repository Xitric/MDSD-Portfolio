...
interface DeviceLibraryIssueCodes {
	...
	val INHERITANCE_CONFLICT = ISSUE_PREFIX + "INHERITANCE_CONFLICT"
	val DUPLICATE_INCLUDE = ISSUE_PREFIX + "DUPLICATE_INCLUDE"
	
	val REQUIRED_PREPROCESS = ISSUE_PREFIX + "REQUIRED_PREPROCESS"
